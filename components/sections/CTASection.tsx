    ...
    <>
      <section className="px-8 py-20" style={{ background: '#3a2e1e' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm font-light leading-loose mb-10" style={{ color: '#c8a878' }}>
            가장 필요한 문장을 골라드립니다. 혹은 이 공간을 오늘 힘든 누군가에게 먼저 건네보세요.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl p-6" style={{ background: '#2a2010', border: '1px solid #5a4828' }}>
              <p className="text-[10px] tracking-widest mb-2" style={{ color: '#a08848' }}>오늘의 문장</p>
              <h3 className="font-hahmlet text-lg font-light mb-2" style={{ color: '#e8d4a8' }}>내 문장 받으러 가기</h3>
              <p className="text-sm font-light leading-loose mb-5" style={{ color: '#b09868' }}>
                이름과 고민을 남기면 당신에게 가장 어울리는 문장을 건네드립니다.
              </p>
